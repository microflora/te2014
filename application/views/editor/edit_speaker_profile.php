...
<h1>Modify Speaker Information - <?php echo $speaker['lastname'].", ".$speaker['firstname']; ?></h1>
		...
		<table border="0" cellpadding="4" cellspacing="0" width="95%">
			...
			<tr>
				<td colspan="2" align="left"><span
					style="text-transform: uppercase;"><strong>Additional Speaker
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td height="21" align="center" valign="middle"
									...
									href="javascript:__doPostBack('Save',<?php echo $speakerid; ?>)"
