    ...
    <div id="sub">
      <div id="subtop" class="clearfix">
        <ul id="nav-sub" class="clearfix">
          ...
          <li><a href="schedulings.asp" class="on"   ><span>TechEd Agenda</span></a></li>
      ...
      <div id="dayAgendas" class="agenda-wrapper">
          <div id="day1" class="show"> 
            ...
            <table width="900" class=" agenda3">
              ...
              <tr>
              	<td colspan="5" class="agenda5"><?php echo date_format(date_create($item["sessiondate"]), "M. j"); ?></td>
              </tr>
              ...
              <tr>
                ...
                <td width="560" ><a href="<?php echo $item['SessionID'].'.asp'; ?>"><?php echo $item['SessionID']."&nbsp;".$item['Title']; ?></a></td>
                ...
                <td width="100" > <?php if ($item['room'] <> "") echo $item['room'];?></td>
               	...
               	<?php
            		...
            		<tr><td width="560"><a href="<?php echo $item['SessionID'].'.asp'; ?>"><?php echo $item['SessionID']."&nbsp;".$item['Title']; ?></a></td><td width="80">
