					...
					<tr valign="top" class="<?php echo $temp; ?>">
						...
						if ($item['TrackID'] == $item2['TrackID']) { ?>
							<li><a href="<?php echo $item2['SessionID'].'.asp'; ?>"
								><?php echo $item2['Title']; ?></a> <?php if ($item2['TypeID'] == 1) echo '<img src="../../images/1hr_lecture.gif" border="0" alt="1-Hour Lecture" />'; else if  ($item2['TypeID'] == 3) echo '<img src="../../images/2hr_handson.gif" border="0" alt="2-Hours Hands-on" />'; else if  ($item2['TypeID'] == 51) echo '<img src="../../images/0.5hr_lecture.gif" border="0" alt="0.5-Hour Lecture" />'; else if  ($item2['TypeID'] == 201) echo '<img src="../../images/3hr_demobooth.gif" border="0" alt="Demo Booth" />'; else echo $item2['Type']; ?>
							</li>
							<?php }
							endforeach; ?>
						</ul>
