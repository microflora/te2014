    ...
    <div id="sub">
      <div id="subtop" class="clearfix">
        <ul id="nav-sub" class="clearfix">
          ...
          <li><a href="tracks.asp"  class="on" ><span>课题大类</span></a></li>
          ...
          <div id="day1" class="show"> 
            ...
            <table class="part-page1 agenda" summary="Event agenda">
          	...
          	<?php $temp = "DataTableRow01";
					...
					<tr valign="top" class="<?php echo $temp; ?>">
						<td>
						<p style="font-weight: bold"><?php echo $item['Track_cn'];?></p>
						</td>
						<td>
						<ul>
						<?php foreach($sessions as $item2):
						if ($item['TrackID'] == $item2['TrackID']) { ?>
							<li><a href="<?php echo $item2['SessionID'].'.asp'; ?>"
								><?php echo $item2['Title_cn']; ?></a> <?php if ($item2['TypeID'] == 1) echo '<img src="../../images/1hr_lecture.gif" border="0" alt="1小时讲座" />'; else if  ($item2['TypeID'] == 3) echo '<img src="../../images/2hr_handson.gif" border="0" alt="2小时实践操作" />';  else if  ($item2['TypeID'] == 51) echo '<img src="../../images/0.5hr_lecture.gif" border="0" alt="半小时讲座" />'; else if  ($item2['TypeID'] == 201) echo '<img src="../../images/3hr_demobooth.gif" border="0" alt="演示展台" />'; else echo $item2['Type_cn']; ?>
							</li>
							<?php }
							endforeach; ?>
						</ul>
