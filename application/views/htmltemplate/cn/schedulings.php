      ...
      <div id="dayAgendas" class="agenda-wrapper">
          <div class="show"> 
            ...
            <table width="900" class=" agenda3">
              ...
              <tr>
              	<td colspan="5" class="agenda5"><?php echo date_format(date_create($item["sessiondate"]), "m月d日"); ?></td>
              </tr>
              ...
              <tr>
				...
				<td  colspan="4">
					<table width="800" class="agenda4">
						<tr>
                        	<td width="560" ><a href="<?php echo $item['SessionID'].'.asp'; ?>"><?php echo $item['SessionID']."&nbsp;".$item['Title_cn']; ?></a></td>
