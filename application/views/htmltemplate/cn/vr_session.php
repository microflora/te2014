...
<ul id="nav-utility-singleline">
	...
	<li id="utilitynav-phone"><a href="http://www.sapteched.com/"
		target="_blank">SAP TechEd 全球网站</a></li>
...
<table class="part-page1 agenda" summary="Event agenda">
	...
	<tr>
		...
		<table width="80%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td><span
					style="FONT: bold 15px/17px Arial, Helvetica, sans-serif; color: #0066b3; line-height: 22px;"><?php echo $item['EditedTitle_cn']; ?></span>
				<p><?php echo $item['EditedAbstract_cn']; ?></p>
				</td>
			</tr>
			...
			<tr>
				<td><b>讲师:</b><?php foreach($speakers as $speaker):
				if ($speaker["speakerapproved"] == 1) {
					echo "<a href='speaker".$speaker["SpeakerID"].".asp'>".$speaker["cn_fullname"]."</a>&nbsp;&nbsp;&nbsp;";
				}else {
					echo $speaker["cn_fullname"]."&nbsp;&nbsp;&nbsp;";
				}
				endforeach; ?><br />
				<br />
			...
			<tr>
				<td><b>日程安排:</b> <a href="vr_sessions.asp"><?php echo date_format(date_create($item["sessiondate"]), "m月d日")."&nbsp;".date_format(date_create($item["starttime"]), "H:i")."-".date_format(date_create($item["endtime"]), "H:i"); ?></a>&nbsp;&nbsp;&nbsp;<?php echo $item["room_cn"]; ?>&nbsp;&nbsp;&nbsp;
				<br />
				<br />
			...
			<tr>
				<td><b>课题大类:</b> <a href="vr_sessions.asp"><?php echo $item['Track_cn']; ?></a><br />
				<br />
