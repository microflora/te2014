    ...
    <div id="sub">
      <div id="subtop" class="clearfix">
        <ul id="nav-sub" class="clearfix">
         <li><a href="home.asp" ><span>大会内容</span></a></li>
          <li><a href="viewall.asp"  class="on"><span>所有讲座</span></a></li>
           <li><a href="tracks.asp"  ><span>课题大类</span></a></li>
           <li><a href="schedulings.asp"  ><span>大会日程</span></a></li>
...
(等级)</th>
	...
	<tr class="<?php echo $temp; ?>">
		...
		(<?php echo $item['Level_cn']; ?>)</td>

		<td valign="top"><a href="<?php echo $item['SessionID'].'.asp'; ?>"><?php echo $item['Title_cn']; ?></a></td>
		<td valign="top"><?php echo $item['Abstract_cn']; ?></td>
		<td valign="top"><?php if ($item['Language'] == 1) echo "中文"; else if  ($item['Language'] == 2) echo "英文"; else echo "未知"; ?></td>
